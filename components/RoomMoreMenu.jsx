...
import { Dices, Gift, Radio, Music2, ShoppingBag, Sparkles, PackageOpen, ChevronDown, Target, CircleDot, Crown } from "lucide-react";

const GAMES = [
 ["/games/ludo","Ludo",Dices],["/games/chess","Chess",Crown],["/games/carrom","Carrom",CircleDot],["/games/archery","Archery",Target]
