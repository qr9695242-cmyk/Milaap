...
export default function GiftBar({ roomId, fromUid, fromName, toUid, toName, targets, myCoins, onClose }) {
 ...
 <div className="grid auto-cols-[64px] grid-rows-5 grid-flow-col gap-2 overflow-x-auto pb-2">
 ...
 >
 <img src={gift.icon} alt={gift.name} className="h-10 w-10 object-contain drop-shadow-lg" loading="lazy" />
