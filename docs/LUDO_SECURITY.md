...
- Winner and Coin payout (coin-to-coin, full pot) are decided in the same server transaction as the winning move.
- Coin payout is idempotent because the match becomes `finished` in the same transaction.
