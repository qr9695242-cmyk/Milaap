...
// currently spends diamonds (cash-out is disabled), so it already
...
export const HOST_LEVELS = [
  ...
  { level: 4, name: "Gold Host", minDiamonds: 1000, icon: "🥇", color: "#F5C34D" },
  { level: 5, name: "Platinum Host", minDiamonds: 5000, icon: "💎", color: "#5ED4E8" },
  { level: 6, name: "Diamond Host", minDiamonds: 15000, icon: "💠", color: "#8B5CF6" },
  { level: 7, name: "Elite Host", minDiamonds: 400000, icon: "👑", color: "#FF3B7F" },
  { level: 8, name: "Legend Host", minDiamonds: 100000, icon: "🔥", color: "#FF8A3D" },
];
