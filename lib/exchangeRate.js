...
// Firestore doc (config/exchangeRate) that only admins can read/write. Public exchange actions use the
// server-side callable function so the rate is not exposed to users.
//
