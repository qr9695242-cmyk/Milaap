...
export const GIFT_CATALOG = [
 { id: "gift1", name: "Rose", icon: "/gifts/gift_001.svg", cost: 20 },
...
export async function sendGift(roomId, { fromUid, fromName, toUid, toName, gift }) {
 ...
 // Unified Milaap host-reward rate: 50,000 gift Coins spent = 1 Diamond.
 // No minimum-1 shortcut: small gifts do not create extra Diamonds.
