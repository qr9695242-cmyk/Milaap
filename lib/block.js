...
export const REPORT_REASONS = [
 ...
 "Scam / fraud",
 "Underage user",
 "Illegal activity or threat of violence",
 "Other",
];

// Reasons serious enough that, alongside the normal in-app report, we also
// point the reporter straight at a human (WhatsApp) instead of just
// waiting on the review queue — see the notice in ReportModal.jsx.
export const URGENT_REPORT_REASONS = ["Underage user", "Illegal activity or threat of violence"];
