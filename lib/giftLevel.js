...
const MIN_GIFT_COINS = 200000; // level 1 threshold
const GIFT_GROWTH_RATE = 1.5; // each level requires 50% more lifetime coins than the one before it
...
// Level 1 = MIN_GIFT_COINS, every level after that is 50% higher than the
// last (raw * 1.5). By level 200 this is an astronomically large number —
