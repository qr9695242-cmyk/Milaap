...
import { GIFT_LEVELS, giftLevelForCoins, nextGiftLevel } from "@/lib/giftLevel";
    ...
    <main className="min-h-screen bg-void pb-28">
      ...
      >
        ...
        <div className="relative mt-4 flex items-center gap-2 rounded-xl bg-black/20 px-3 py-2 ring-1 ring-white/10 backdrop-blur-sm">
          ...
          <p className="text-xs text-ink/90">
            <span className="font-bold">{gifted.toLocaleString()}</span> coins gifted (lifetime)
          </p>
        </div>
        ...
        {next ? (
          <div className="relative mt-4">
            ...
            <p className="mt-1.5 text-[11px] text-mist">
              <span className="font-semibold text-ink/80">{(next.minCoins - gifted).toLocaleString()} coins</span> ka
      ...
      <section className="mx-5 mt-4">
        ...
        >
          ...
          <p className="relative mt-2 text-xs text-mist">{selected.minCoins.toLocaleString()}+ coins gifted (lifetime)</p>
        </div>
      </section>
