...
import { giftLevelForCoins } from "@/lib/giftLevel";
...
export default function PublicProfilePage() {
 ...
 const targetGiftTier = giftLevelForCoins(target.totalCoinsGifted || 0);
 ...
 {targetGiftTier.icon} Gift Lv.{targetGiftTier.level}
 </span>
 </div>
