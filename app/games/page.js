...
export default function GamesPage(){
 ...
 <p className="mt-1 text-xs text-mist">4 real games • board and skill gameplay</p>
 </div>
 <span className="premium-chip">4 GAMES</span>
 </div>
 </header>

 <div className="mx-5 mt-4 rounded-2xl bg-amber-400/10 px-4 py-3 text-center ring-1 ring-amber-300/20">
 <p className="text-[11px] font-black text-amber-200"> — </p>
 <p className="mt-1 text-[10px] leading-4 text-mist">Coins may be used as game entry/stake and virtual rewards. betting, cash withdrawal, or cash-out is available.</p>
 </div>
