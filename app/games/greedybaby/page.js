...
// GreedyBaby — virtual-coin catch game. No real-money wagering or cash-out.
      ...
      <main className="game-screen min-h-screen bg-void text-ink pb-10">
        ...
        <section className="mx-4 rounded-3xl bg-panel p-5 text-center ring-1 ring-white/10">
          ...
          <p className="mt-4 text-[10px] leading-4 text-mist/70">
            GreedyBaby is an entertainment-only mini-game. It uses Milaap virtual coins only. No real-money wagering or cash-out is added.
          </p>
        </section>
      </main>
    );
